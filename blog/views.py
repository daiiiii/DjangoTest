...
def detail(request, pk):
    ...
    context = {'post': post, 'form': form, 'comment_list': comment_list, 'post_list': post_list}
...
def study(request):
    ...
    menu_list = Catalog.objects.all()
    return render(request, 'blog/study.html', context={'post_list': post_list, 'menu_list': menu_list})
